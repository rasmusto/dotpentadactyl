...
<VimperatorPlugin>
  ...
  <detail><![CDATA[
    ...
    Example.
    >||
    :js dactyl.plugins.smooziee.smoothScrollBy(600)
    :js dactyl.plugins.smooziee.smoothScrollBy(-600)
    ||<
...
let self = dactyl.plugins.smooziee = (function(){
  ...
  var PUBLICS = {
    smoothScrollBy: function(moment) {
      ...
      interval = window.eval(dactyl.globalVariables.smooziee_scroll_interval) || 20;
  ...
  function getScrollAmount() window.eval(dactyl.globalVariables.smooziee_scroll_amount) || 400;
